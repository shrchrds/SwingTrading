...
def main():
    ...
    etf_codes = [
        ...
        'HDFCMOMENT.NS', 'QUAL30IETF.NS', 'NV20IETF.NS', 'GROWWEV.NS',
        ...
        'ITBEES.NS', 'MOM100.NS', 'MNC.NS', 'OILIETF.NS', 'HEALTHY.NS',
        'JUNIORBEES.NS', 'PHARMABEES.NS', 'PVTBANIETF.NS', 'PSUBNKBEES.NS',
        'HDFCSML250.NS', 'MASPTOP50.NS', 'MIDSMALL.NS', 'METALIETF.NS',
        'ICICIB22.NS', 'MOVALUE.NS', 'SMALLCAP.NS', 'MOREALTY.NS', 'MAFANG.NS',
        'SILVERBEES.NS', 'MONQ50.NS', 'ESG.NS', 'MON100.NS', 'JUNIORBEES.NS', 'ABSLPSE.NS'
    ]
